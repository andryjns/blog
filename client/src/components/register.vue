    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">New to Go-Blog?</h5>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <input id="passwordRegister" type="password" class="form-control" placeholder="Password" required="required"
    ...
    methods: {
      register: function () {
        if (this.nameRegister === '' || this.passwordRegister === '' || this.emailRegister === '') {
          this.errorMsg = 'Input is incomplete'
        } else {
          let self = this
          axios({
              method: 'post',
            ...
            .then(user => {
              ...
              self.successMsg = 'Registration done'
            })
            .catch(err => {
              self.errorMsg = 'Registration is failed'
            })
        }
      }
    }
